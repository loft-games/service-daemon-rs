...
*   When you use `#[service]`, a static entry is generated and added to a distributed slice (backed by the `linkme` crate).
...
For a deep dive into how macros generate these entries, see [Macros Deep Dive](docs/architecture/macros-deep-dive.md).
...
Learn more about the internal orchestration logic in the [Internal Overview](docs/architecture/internal-overview.md).
...
Explore advanced [Lifecycle Management](docs/architecture/lifecycle-management.md) to see how components collaborate.

---

[**<- Previous Step: Unit Testing & Simulation**](docs/guide/tutorial/unit-testing.md) | [**Next Step: Custom Trigger Implementation ->**](docs/guide/tutorial/tailor-made-triggers.md)
