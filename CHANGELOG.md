...
- **HighPriority Runtime Policy**: Added `HighPriorityRuntimePolicy` and `ServiceDaemonBuilder::with_high_priority_runtime_policy(...)` for conservative HighPriority shard placement, scale-out, worker caps, cooldowns, and cooperative rollover.
