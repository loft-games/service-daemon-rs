...
- **HighPriority Runtime Control**: Added conservative automatic HighPriority shard placement, scale-out within worker caps, and cooperative rollover inside the declared `HighPriority` scheduling mode.
